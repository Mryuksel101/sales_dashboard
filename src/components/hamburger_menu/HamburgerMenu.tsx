...
const HamburgerMenu: React.FC = () => {
    ...
    return (
        <div className="md:hidden">
            ...
            <div
                className={`fixed top-0 left-0 w-full h-full bg-black z-40 transform-gpu transition-opacity ease-in ${isOpen ? 'opacity-50 pointer-events-auto' : 'opacity-0 pointer-events-none'
                    }`}
                onClick={
                    toggleMenu
                }
